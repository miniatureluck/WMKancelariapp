...
namespace WMKancelariapp.Data.Migrations
{
    ...
    [Migration("20230702180005_OnDeleteNulls")]
    partial class OnDeleteNulls
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WMKancelariapp.Models.HourlyPrice", b =>
                {
                    ...
                    b.HasOne("WMKancelariapp.Models.UserTask", "Task")
                        .WithOne("Price")
                        .HasForeignKey("WMKancelariapp.Models.HourlyPrice", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
